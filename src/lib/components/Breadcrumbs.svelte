		...
		{#if $location}
			...
			{#if $location.m1}
				...
				{#if $location.title}
					<li class="crumb">
						<a
							href={`${base}/tag/` + slugify($location.m1)}
							style:border-bottom={`2px solid ${topicColors[$location.t1]}`}>{$location.m1}</a
						> >
					</li>
				{/if}
			{/if}
			...
			{#if $location.t2 && $location.m2 && !$isMobile}
				<li class="crumb">
					&lt; <a
						href={`${base}/tag/` + slugify($location.m2)}
						style:border-bottom={`2px solid ${topicColors[$location.t2]}`}>{$location.m2}</a
					>
				</li>
				<li class="crumb">
					&lt; <a
						href={`${base}/tag/` + slugify($location.t2)}
						style:border-bottom={`2px solid ${topicColors[$location.t2]}`}>{$location.t2}</a
					>
				</li>
				<li class="crumb">&lt; <a href="{base}/">Home</a></li>
			{/if}
